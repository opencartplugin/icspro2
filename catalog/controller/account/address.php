...
class ControllerAccountAddress extends Controller {
	...
	protected function getForm() {
        ...
        $data['entry_district'] = $this->language->get('entry_district');//frd 3
        $data['entry_subdistrict'] = $this->language->get('entry_subdistrict');//frd 3
        ...
        if (isset($this->request->post['district_id'])) {
    		...
    		if (isset($this->request->post['subdistrict_id'])) {
    			...
    			$data['subdistrict_id'] = $address_info['subdistrict_id'];
    		} else {
    			$data['subdistrict_id'] = '';
    		}
    	    		//------
